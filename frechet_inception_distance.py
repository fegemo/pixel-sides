...
def compare(dataset1_or_path, dataset2_or_path):
    ...
    # fid between images1 and images2... can call with either np vector or strings representing paths to folders
    # test_images_path = images1
    # generated_images_path = images2
    fid = _compare_datasets(dataset1_or_path, dataset2_or_path, inception_model)
    # print(f"FID {fid:.3f}")
    return fid
