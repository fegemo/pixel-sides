# Extracted from: https://github.com/mvoelk/keras_layers
...
class MaxUnpooling2D(Layer):
    ...
    def call(self, inputs, output_shape=None):
        ...
        # print(f"type of updates is {type(updates)}")
        ...
        # print(f"updates.shape is {updates.shape}")
        ...
        # print(f"one_like_mask {one_like_mask}")
